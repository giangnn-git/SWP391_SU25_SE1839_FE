...
const centers = [
  "HCM Service Center",
  "Hanoi Service Center",
  "Danang Service Center",
];
...
const DistributePartModal = ({ part, onClose }) => {
  ...
  const handleConfirm = () => {
    ...
    if (!center || !amount) {
      setFeedback({
        type: "error",
        message: "Please select a service center and enter quantity.",
      });
      return;
    }
  ...
  return (
    <div className="fixed inset-0 bg-black/40 flex items-center justify-center z-50">
      <div
        className={`bg-white rounded-xl shadow-lg w-[400px] p-6 transform transition-all duration-300 ${
