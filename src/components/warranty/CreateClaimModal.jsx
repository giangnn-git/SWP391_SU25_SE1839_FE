                ...
                <div className="p-6 space-y-5">
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            className={`w-full px-4 py-2.5 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition ${errors.description
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input
                                ...
                                className={`w-full px-4 py-2.5 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition ${errors.mileage
                                    ? "border-red-300 bg-red-50"
                                    : "border-gray-300"
                                    }`}
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className={`w-full px-4 py-2.5 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition ${errors.vin
                                    ? "border-red-300 bg-red-50"
                                    : "border-gray-300"
                                    }`}
                                value={formData.vin}
