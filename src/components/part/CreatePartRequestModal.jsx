...
import { getAllPartsApi, createPartRequestApi } from "../../services/api.service";
...
const CreatePartRequestModal = ({ onClose, onCreated }) => {
    ...
    const handleAdd = () => setRows([...rows, { category: "", partId: "", quantity: "" }]);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (status === 500 && data?.errorCode?.includes("Failed to convert value")) {
                setError("Server error: Invalid data format. Please check part selection.");
            } else if (status === 400) {
