...
const WarrantyClaimsManagement = () => {
  ...
  const filteredClaims = claims.filter((c) => {
    ...
    const matchStatus =
      statusFilter === "all"
        ? true
        : c.currentStatus?.toLowerCase() === statusFilter.toLowerCase();
  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen">
      ...
      <div className="text-sm text-gray-500 mb-2">
        ...
        <Link
          to="/warranty-claim-approvals"
          className="text-gray-700 font-medium"
        >
          Warranty Claim Approvals
        </Link>
      </div>
      ...
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-gray-900">
          Warranty Claim Approvals Management
        </h1>
        <p className="text-gray-600 text-sm mt-1">
          Manage and track all warranty claim approvals
        </p>
      </div>
